...
class FotograferDetailsView extends GetView<FotograferDetailsController> {
  const FotograferDetailsView({Key? key}) : super(key: key);
  @override
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Bisa Berkomunikasi Dengan Bahasa',
                      style: TextStyle(
                          fontSize: 16, fontWeight: FontWeight.bold),
                    ),
                    const SizedBox(
                    ...
                    buildItem('1', '100 lebih file mentahan'),
                    buildItem('2', '2 cetak 10R'),
                    const SizedBox(
                      height: 20,
                    ),
                  ],
